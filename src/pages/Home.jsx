      ...
      <section className="hero" id="home">
        ...
        <div className="hero-content">
          <div className="hero-badges animate-on-scroll">
            <span className="badge"><i className="fas fa-award"></i> Siemens SIEPAN ELITE Partner</span>
            <span className="badge"><i className="fas fa-shield-alt"></i> CPRI Tested</span>
            <span className="badge"><i className="fas fa-certificate"></i> IEC 61439-1 &amp; 2</span>
          </div>
          ...
          <div className="hero-cta animate-on-scroll">
            <Link to="/products" className="btn btn-primary"><i className="fas fa-bolt"></i> Explore Products</Link>
            <Link to="/contact" className="btn btn-outline"><i className="fas fa-envelope"></i> Enquire Now</Link>
          </div>
          <div className="hero-brands animate-on-scroll">
            <div className="hero-brand-item">
              <span className="brand-icon-lg">⚡</span>
              <div><strong>Vajra Panels™</strong><small>Precision Engineered</small></div>
            </div>
        ...
        <div className="container">
          ...
          <div className="about-redesign-grid">
            ...
            <div className="about-redesign-right animate-on-scroll">
              {[
                { icon: 'fa-handshake', title: 'Siemens SIEPAN ELITE', sub: 'Authorized Technology Partner' },
                { icon: 'fa-bolt', title: 'CPRI Test Report — 70kA', sub: 'Authorized up to 6600A at 415V' },
                { icon: 'fa-certificate', title: 'IEC 61439-1 & 2', sub: 'Indicated country to IEC standards' },
              ].map(({ icon, title, sub }) => (
              ...
              <div className="about-cta-row">
                <Link to="/products" className="btn btn-primary btn-sm"><i className="fas fa-th-large"></i> Explore Products</Link>
                <Link to="/contact" className="btn btn-outline btn-sm"><i className="fas fa-envelope"></i> Enquire Now</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="cert-grid">
            <div className="cert-card-enhanced animate-on-scroll">
              <div className="cert-icon-enhanced"><i className="fas fa-award"></i></div>
            ...
            <div className="cert-card-enhanced animate-on-scroll">
              <div className="cert-icon-enhanced"><i className="fas fa-flask"></i></div>
            ...
            <div className="cert-card-enhanced animate-on-scroll">
              <div className="cert-icon-enhanced"><i className="fas fa-certificate"></i></div>
            ...
            <div className="cert-card-enhanced animate-on-scroll">
              <div className="cert-icon-enhanced"><i className="fas fa-cogs"></i></div>
            ...
            {[
              ...
              <div className="product-card-enhanced animate-on-scroll" key={title}>
                ...
                <div className="product-info">
                  ...
                  <p>{desc}</p>
                  <Link to="/contact" className="btn btn-sm">Enquire <i className="fas fa-arrow-right"></i></Link>
                </div>
              </div>
            ))}
          </div>
          <div style={{ textAlign:'center', marginTop:40 }}>
            <Link to="/products" className="btn btn-primary"><i className="fas fa-th-large"></i> View All Products</Link>
          </div>
        </div>
      </section>
