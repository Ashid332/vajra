...
export default function Team() {
  ...
  const experts = [
    ...
    },
    {
      ...
      image: "/images/team-monalisa.png"
    },
    {
      name: "Mr. Thirumalesh",
          ...
          <div className="legacy-grid">
            ...
            <div className="legacy-content animate-on-scroll">
              <div className="legacy-logo-top">
                <img src="/images/arul-group-logo.png" alt="Arul Group" style={{ maxWidth: '180px', marginBottom: '24px' }} />
              </div>
              ...
              <div className="legacy-logos">
                <div className="logo-item">
                  <span style={{ fontWeight: 700, color: '#0A2A5E' }}>ARUL POLYMERS</span>
                </div>
                <div className="logo-item">
                  <span style={{ fontWeight: 700, color: '#0A2A5E' }}>ARUL RUBBERS</span>
                </div>
                <div className="logo-item" style={{ background: '#DCE775' }}>
                  <span style={{ fontWeight: 700, color: '#0A2A5E' }}>Neo Studio</span>
                </div>
              </div>
